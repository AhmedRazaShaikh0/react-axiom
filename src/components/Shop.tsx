    ...
    return (
        ...
        <div className=' w-[80%] flex justify-between mb-[350px] sm:mb-[0px] m-auto sm:flex-row flex-col-reverse h-[15cm]'>
            <div className='flex relative lg:w-[15cm]'>
                ...
                <img src="/img3.jpg" alt="" className='absolute top-[0px] sm:top-[10px] left-[10px] sm:left-[20px] w-[90px] sm:w-[180px] reveal' />
                <img src="/img2.jpg" alt="" className='absolute top-[140px] sm:top-[240px] left-[30px] sm:left-[40px] w-[100px] sm:w-[200px] reveal' />
                <img src="/img5.jpg" alt="" className='absolute top-[40px] sm:top-[90px] left-[210px] sm:left-[400px] w-[50px] sm:w-[100px] reveal' />
                <img src="/img4.jpg" alt="" className='absolute top-[140px] sm:top-[260px] left-[200px] sm:left-[400px] w-[80px] sm:w-[160px] reveal' />
            </div>
