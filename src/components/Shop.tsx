    ...
    return (
        ...
        <div className=' w-[80%] flex justify-between mb-[350px] sm:mb-[0px] m-auto lg:flex-row flex-col-reverse h-[15cm]'>
            ...
            <div className=' sm:w-1/3 my-auto '>
                ...
                <button className='text-white hover:text-black bg-[#111111] hover:bg-white transition-all duration-500 border-2 border-black font-bold px-[20px] py-[12px] mt-[20px] lg:mr-[20px]'>Shop Tops</button><br className='sm:hidden' />
                <button className='text-white hover:text-black bg-[#111111] hover:bg-white transition-all duration-500 border-2 border-black font-bold px-[20px] py-[12px] mt-[20px] '>Shop All Womens</button>
            </div>
        </div>
    )
}
